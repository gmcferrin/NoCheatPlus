 ...
 * 
 */
public class ReachCheck extends BlockInteractCheck {

    public class ReachCheckEvent extends BlockInteractEvent {
    ...
    public boolean check(final NCPPlayer player, final Object... args) {
        ...
        final SimpleLocation placedAgainstBlock = data.blockInteracted;
